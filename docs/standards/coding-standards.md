...
Правила относятся к SPA **`cnt_gq_web`** и целевой структуре слоёв из [frontend.md](../architecture/specs/frontend.md). Именование компонентов и файлов — в [react.md](naming/react.md).
